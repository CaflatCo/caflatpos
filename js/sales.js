...
function if(typeof showNotification==='function') showNotification('DIAG:setCart reached','info');
  setCart(cart) {
...
function renderCart() {
  if(typeof showNotification==='function') showNotification('DIAG:renderCart reached','info');
...
function addToCart(productId, variant = null) {
  if(typeof showNotification==='function') showNotification('DIAG:addToCart','info');
  const product = getProductById(productId);
  if(typeof showNotification==='function') showNotification(product ? 'DIAG:getProductById success' : 'DIAG:getProductById failed','info');
