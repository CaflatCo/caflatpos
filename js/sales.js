...
function openHeldOrdersModal() {
  ...
  list.innerHTML=held.map((o,i)=>`<div class="held-item"><button data-held-index="${i}" class="resume-held-btn">Resume</button> ${o.customerName||'Held Order'} </div>`).join('') || '<p>No held orders</p>';
