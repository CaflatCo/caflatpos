...
function setCart(cart) {
  if (typeof showNotification==='function') showNotification('DIAG:setCart','info');
  updateState('cart', () => Array.isArray(cart) ? cart : []);
  if (typeof showNotification==='function') showNotification('DIAG:afterUpdateState','info');
  renderCart();
  if (typeof showNotification==='function') showNotification('DIAG:afterRenderCart','info');
  updateCartSummary();
}
